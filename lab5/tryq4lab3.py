...
"""# ECC KEY FLOW
#
# Alice: Temporary Private Key + Bob's Public Key
#                         |
#                         v
#                   Shared Secret
#
# Bob:   Bob's Private Key + Alice's Temporary Public Key
#                         |
#                         v
#                Same Shared Secret
#
# Shared Secret -> HKDF -> Same AES Key
#
# Alice sends Bob: temporary public key + nonce + ciphertext"""